...
class UpdateCouponRequest extends FormRequest
{
    ...
    {
        $rules = [
            'code' => ['required', 'string', 'max:32', 'unique:' . Coupon::class . ',code,' . $this->coupon . ',id,deleted_at,NULL'],
            'name' => ['required', 'string', 'max:64', 'unique:' . Coupon::class . ',name,' . $this->coupon . ',id,deleted_at,NULL'],
            'description' => ['string'],
            'start_date' => ['date'],
