<div class="relative">
  ...
  <div class="max-w-3xl relative z-10 mx-auto flex items-center flex-col text-center py-16 px-4 sm:py-20 px-10 sm:px-6" x-data>
    ...
    >
      <span class="block text-lg font-medium tracking-wide md:text-xl">With Atelier, your products will always be placed <br> in front of customers who are already looking for <br> your unique pieces</span>
    </h2>
    <x-elements.button title="Open my shop" :link="route('web-app')" x-intersect="$el.classList.add('slide-in-bottom')">
      <x-slot name="icon">
