<div class="relative" x-data>
  ...
  >
    <h2 class="text-white">
      <span class="block text-lg uppercase tracking-wider font-semibold">{{ __('cta.available-now') }}</span>
      <span class="block text-2xl font-medium tracking-wide sm:text-4xl">{{ __('cta.get-it-on-app-store') }}</span>
    </h2>
{{--    <x-elements.button title="{{ __('cta.get-it-for-ios') }}" link="https://apps.apple.com/app/atelier/id1565516356">--}}
    <x-elements.button title="{{ __('cta.get-it-for-ios') }}" >
      <x-slot name="icon">
