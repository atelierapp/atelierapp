<div class="relative">
  ...
  <div class="max-w-2xl relative z-10 mx-auto flex items-center flex-col text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
    ...
    <x-elements.button title="Test our app" link="mailto:info@0110atelier.com?subject=I%20want%20to%20test%20the%20Atelier%20App&body=I%20want%20to%20try%20the%20app.%20Please%20add%20me%20to%20your%20user%20list">
      <x-slot name="icon">
