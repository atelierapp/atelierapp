...
>
  ...
  <input
      ...
      type="{{ $type ?? 'text' }}"
      @class([
        'py-4 px-6 block w-full sm:text-sm sm:leading-5 outline-none ring ring-[2px] ring-gray-700 focus:ring-gray-800 focus:shadow-outline-gray text-gray-900 placeholder-gray-300',
