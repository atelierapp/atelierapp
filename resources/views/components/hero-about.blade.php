    ...
    <div class="relative w-full flex items-center justify-center">
      ...
      <div class="absolute absolute bottom-0 right-0">
        <div class="pb-16 max-w-lg">
          ...
          <x-elements.button link="" title="Download App" link="https://apps.apple.com/es/app/atelier-home-design/id1448129816">
            <x-slot name="icon">
              <svg class="w-4 fill-current hover:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14.1 16.43"><defs/><path fill="#bfe0d8" d="M13.69 10.56l-5.64 5.47a1.44 1.44 0 01-2 0L.41 10.56A1.35 1.35 0 010 9.59a1.39 1.39 0 011.4-1.37 1.43 1.43 0 011 .4l3.24 3.14V1.36a1.41 1.41 0 012.82 0v10.4l3.24-3.14a1.43 1.43 0 011-.4 1.4 1.4 0 011.4 1.37 1.35 1.35 0 01-.4.97z"/></svg>
            </x-slot>
          </x-elements.button>
        </div>
      </div>
