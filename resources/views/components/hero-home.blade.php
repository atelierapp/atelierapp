    ...
    <div class="flex flex-col-reverse lg:grid lg:grid-cols-12 lg:gap-8">
      ...
      <div class="mt-12 relative sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-6 lg:flex lg:items-center">
        ...
        <div class="lg:py-24 flex flex-col space-y-3 md:space-y-4">
          ...
          <span class="uppercase text-xl text-pink-900 tracking-wide font-medium" x-intersect="$el.classList.add('slide-in-bottom')">Easy & simple design</span>
          ...
          >
            <x-elements.button title="Test the app" link="https://apps.apple.com/app/atelier-home-design/id1448129816">
              <x-slot name="icon">
