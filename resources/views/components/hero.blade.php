    ...
    <div class="flex flex-col-reverse lg:grid lg:grid-cols-12 lg:gap-8">
      ...
      <div class="mt-12 relative sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-6 lg:flex lg:items-center">
        ...
        <div class="lg:py-24 flex flex-col space-y-4">
          <div class="bg-white rounded-xl w-20 shadow">
          ...
          <span class="uppercase text-xl text-pink-900 tracking-wider">Easy & simple design</span>
          <h1 class=" text-4xl tracking-wide text-pink-900 sm:text-6xl xl:text-5xl">
            <span>The easiest-to-use tool to design your home</span>
          </h1>
          <x-elements.button title="Get it from the App Store" link="https://apps.apple.com/es/app/atelier-home-design/id1448129816">
            <x-slot name="icon">
