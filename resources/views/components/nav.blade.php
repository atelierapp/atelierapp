      ...
      <div class="flex justify-start lg:w-0 lg:flex-1">
        <a href="{{ \Request::route()->getName() === 'home' ? '#' : route('home') }}">
          <div class="flex flex-row items-center justify-center">
            ...
            <span class="ml-4 font-semibold text-black text-lg uppercase tracking-wider">Atelier</span>
          </div>
        </a>
      </div>
      ...
      <nav class="hidden md:flex space-x-10">
        <div class="relative">
          <a href="{{ \Request::route()->getActionName() == 'about' ? '#' : route('about') }}">
            <button type="button"
                    class="text-gray-800 group bg-white rounded-md inline-flex items-center text-base {{ \Request::route()->getName() == 'about' ? 'font-semibold' : 'font-regular' }} hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                    aria-expanded="false">
              <span>About</span>
            </button>
          </a>
